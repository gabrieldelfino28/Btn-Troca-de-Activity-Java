...
public class TelaRecebeDados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( extras != null) {
            ...
            Toast.makeText(this, "extras foi nulo", Toast.LENGTH_SHORT).show();
            editTextNestaActivityQueMostraONomeRecebido.setText("nome nao foi informado na activity antetior");
        }
    }
}
